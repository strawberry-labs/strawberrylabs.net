    ...
    return (
        <Box>
            ...
            <SimpleSlider slidesToShow={1} horizontalMargin={4} arrows={true}>
                <Testimonial
                    text1="Strawberry Labs' team established a streamlined ticketing process for timely delivery"
                    text2="The app has earned a positive response so far, securing large orders from end clients. Moreover, Strawberry Labs’ team has established a streamlined ticketing process to ensure timely delivery. They’re communicative, deliver high-quality work, and even recommend alternative solutions to improve the app."
                ...
                />
                <Testimonial
                    text1="Strawberry Labs' team established a streamlined ticketing process for timely delivery 2"
                    text2="The app has earned a positive response so far, securing large orders from end clients. Moreover, Strawberry Labs' team has established a streamlined ticketing process to ensure timely delivery. They’re communicative, deliver high-quality work, and even recommend alternative solutions to improve the app."
                    person="Senior Software Engineer Greenwald Industries"
                    country="USA"
                    summary="Mobile app for laundry hardware payment company"
