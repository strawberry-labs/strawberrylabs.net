  ...
  return (
    ...
    >
      ...
      <Card minW={"60"} maxW={{ lg: "6xl" }} maxH={"3xl"}>
        <Image
          src="https://images.unsplash.com/photo-1516054719048-38394ee6cf3e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
        ...
        <CardBody>
          <Stack spacing={4} align="start" m="4">
            <Text>
              Tool for effective diagnoses of skin conditions and related
              diseases with a further treatment routine.
            </Text>
